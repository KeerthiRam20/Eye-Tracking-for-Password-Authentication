...
def StartCamera():
    	...
    	return render_template("register.html",message="Snap Get SuccesFully")
...
def log_in():
	...
	if request.form['cid'] != None and request.form['cid'] != "" and request.form['pin'] != None and request.form['pin'] != "":
		...
		if(isRecordExist==1):
			...
			headers = {'authorization':"onjgiAGhVkbEeN3H80m19fMXrl4FzKdYyuI7QS5TDCOcqpstW2D1Ym4FTCHWLKMBdRc8aQzNrIy5pk9t",'Content-Type': "application/x-www-form-urlencoded",'Cache-Control': "no-cache",}
